...
def run_single_experiment(args, config: dict):
    ...
    config_128_4_256 = copy.deepcopy(config)
    config_128_4_256['model']['d_model'] = 128
    config_128_4_256['model']['nhead'] = 4
    config_128_4_256['model']['dim_feedforward'] = 256
    benchmark.models['Ours_128_4_256'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_128_4_256
    )
    print("[✓] Ours - Transformer d_model 128, nhead 4, dim_feedforward 256")

    config_192_6_384 = copy.deepcopy(config)
    config_192_6_384['model']['d_model'] = 192
    config_192_6_384['model']['nhead'] = 6
    config_192_6_384['model']['dim_feedforward'] = 384
    benchmark.models['Ours_192_6_384'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_192_6_384
    )
    print("[✓] Ours - Transformer d_model 192, nhead 6, dim_feedforward 384")

    # 添加我们的模型（Time-Aware Transformer）
    benchmark.models['Ours_128_8_128'] = Stage1TimeAwareTransformer(
