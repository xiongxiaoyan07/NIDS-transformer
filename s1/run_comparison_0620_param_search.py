...
def run_single_experiment(args, config: dict):
    ...
    print("\n[INFO] Adding Hyperparameter Search Models")
    ...
    for trial, (lr, dropout, wd) in enumerate(all_configs[:100]):
    ...
    results = benchmark.run_all_1(num_epochs=args.num_epochs, seed=args.seed)
