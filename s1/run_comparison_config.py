...
def run_single_experiment(args, config: dict):
    ...
    # models['Ours_NoTime'] = Stage1TimeAwareTransformer(
    #     input_dim=input_dim,
    #     cfg=config_no_time
    # )
    ...
    # models['Ours_NoPos'] = Stage1TimeAwareTransformer(
    #     input_dim=input_dim,
    #     cfg=config_no_pos
    # )
    ...
    # models['Ours_NoEncoding'] = Stage1TimeAwareTransformer(
    #     input_dim=input_dim,
    #     cfg=config_none
    # )
    ...
    # models['Ours_BothEncoding'] = Stage1TimeAwareTransformer(
    #     input_dim=input_dim,
    #     cfg=config_both
    # )
    ...
    # 5. 16头注意力
    config_nhead16 = copy.deepcopy(config)
    config_nhead16['model']['nhead'] = 16
    benchmark.models['Ours_nhead16'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_nhead16
    )
    print("[✓] Ours - Transformer 16 head")

    # 5. 8头注意力
    config_nhead8 = copy.deepcopy(config)
    config_nhead8['model']['nhead'] = 8
    benchmark.models['Ours_nhead8'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_nhead8
    )
    print("[✓] Ours - Transformer 8 head")

    # 5. 4头注意力
    config_nhead4 = copy.deepcopy(config)
    config_nhead4['model']['nhead'] = 4
    benchmark.models['Ours_nhead4'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_nhead4
    )
    print("[✓] Ours - Transformer 4 head")

    # 5. 2头注意力
    config_nhead2 = copy.deepcopy(config)
    config_nhead2['model']['nhead'] = 2
    benchmark.models['Ours_nhead2'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_nhead2
    )
    print("[✓] Ours - Transformer 2 head")

    # 5. 2 num_layers
    config_num_layers2 = copy.deepcopy(config)
    config_num_layers2['model']['num_layers'] = 2
    benchmark.models['Ours_num_layers2'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_num_layers2
    )
    print("[✓] Ours - Transformer 2 layers")

    # 5. 2num_layers
    config_num_layers4 = copy.deepcopy(config)
    config_num_layers4['model']['num_layers'] = 4
    benchmark.models['Ours_num_layers4'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_num_layers4
    )
    print("[✓] Ours - Transformer 4 layers")

    # 5. 2 num_layers
    config_num_layers6 = copy.deepcopy(config)
    config_num_layers6['model']['num_layers'] = 6
    benchmark.models['Ours_num_layers6'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_num_layers6
    )
    print("[✓] Ours - Transformer 6 layers")

    # 5. 2 num_layers
    config_num_layers8 = copy.deepcopy(config)
    config_num_layers8['model']['num_layers'] = 8
    benchmark.models['Ours_num_layers8'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_num_layers8
    )
    print("[✓] Ours - Transformer 8 layers")

    # 5. 2 dim_feedforward
    config_dim_feedforward128 = copy.deepcopy(config)
    config_dim_feedforward128['model']['dim_feedforward'] = 128
    benchmark.models['Ours_dim_feedforward128'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward128
    )
    print("[✓] Ours - Transformer 128 dim_feedforward")

    # 5. 2 dim_feedforward
    config_dim_feedforward256 = copy.deepcopy(config)
    config_dim_feedforward256['model']['dim_feedforward'] = 256
    benchmark.models['Ours_dim_feedforward256'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward256
    )
    print("[✓] Ours - Transformer 256 dim_feedforward")

    # 5. 2 dim_feedforward
    config_dim_feedforward512 = copy.deepcopy(config)
    config_dim_feedforward512['model']['dim_feedforward'] = 512
    benchmark.models['Ours_dim_feedforward512'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward512
    )
    print("[✓] Ours - Transformer 512 dim_feedforward")

    # 5. 2 dim_feedforward
    config_dim_feedforward1024 = copy.deepcopy(config)
    config_dim_feedforward1024['model']['dim_feedforward'] = 1024
    benchmark.models['Ours_dim_feedforward1024'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward1024
    )
    print("[✓] Ours - Transformer 1024 dim_feedforward")
