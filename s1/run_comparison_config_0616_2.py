...
def run_single_experiment(args, config: dict):
    ...
    # 5. 16头注意力
    config_dim_feedforward128nhead8num_layers2 = copy.deepcopy(config)
    config_dim_feedforward128nhead8num_layers2['model']['dim_feedforward'] = 128
    config_dim_feedforward128nhead8num_layers2['model']['nhead'] = 8
    config_dim_feedforward128nhead8num_layers2['model']['num_layers'] = 2
    benchmark.models['Ours_dim_feedforward128nhead8num_layers2'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward128nhead8num_layers2
    )
    print("[✓] Ours - Transformer dim_feedforward=128 nhead=8 num_layers=2")
    ...
    config_dim_feedforward128nhead8num_layers6 = copy.deepcopy(config)
    config_dim_feedforward128nhead8num_layers6['model']['dim_feedforward'] = 128
    config_dim_feedforward128nhead8num_layers6['model']['nhead'] = 8
    config_dim_feedforward128nhead8num_layers6['model']['num_layers'] = 6
    benchmark.models['Ours_dim_feedforward128nhead8num_layers6'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward128nhead8num_layers6
    )
    print("[✓] Ours - Transformer dim_feedforward=128 nhead=8 num_layers=6")

    config_dim_feedforward128nhead8num_layers8 = copy.deepcopy(config)
    config_dim_feedforward128nhead8num_layers8['model']['dim_feedforward'] = 128
    config_dim_feedforward128nhead8num_layers8['model']['nhead'] = 8
    config_dim_feedforward128nhead8num_layers8['model']['num_layers'] = 8
    benchmark.models['Ours_dim_feedforward128nhead8num_layers8'] = Stage1TimeAwareTransformer(
        input_dim=input_dim,
        cfg=config_dim_feedforward128nhead8num_layers8
    )
    print("[✓] Ours - Transformer dim_feedforward=128 nhead=8 num_layers=8")
